...
\cvevent{Machine Learning Fellow, Associate Data Scientist}{Launchpad.ai}{October 2018 -- November 2019}{New York, NY}
\begin{itemize}
...
\includegraphics[scale=0.110]{terrance.jpg}
\label{fig:subfig1}
}
\subfigure[Rousey II]{
\includegraphics[scale=0.110]{rousey2.jpg}
\label{fig:subfig2}
}
\subfigure[Connie]{
\includegraphics[scale=0.110]{connie.jpg}
\label{fig:subfig3}
}
\subfigure[Jaegar]{
\includegraphics[scale=0.110]{jaegar.jpg}
\label{fig:subfig4}
}
